...
const styles = StyleSheet.create({
  ...
  title: { color: colors.onHeader, fontSize: 18, lineHeight: 22, fontWeight: '900' },
  subtitle: { color: colors.onHeaderMuted, fontSize: 13, lineHeight: 18, fontWeight: '800', marginTop: 3 },
