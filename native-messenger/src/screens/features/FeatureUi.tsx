  ...
  return (
    <View style={styles.row}>
      <View style={styles.avatar}>
        {avatar ? <Image source={{ uri: avatar }} style={styles.avatarImage} resizeMode="cover" /> : <Text style={styles.avatarText}>{initials(user.name)}</Text>}
      </View>
...
const styles = StyleSheet.create({
  ...
  pageHeaderTitle: { color: colors.title, fontSize: 24, lineHeight: 29, fontWeight: '900' },
  ...
  sectionTitle: { color: colors.title, fontSize: 16, lineHeight: 20, fontWeight: '900' },
  ...
  avatar: { width: 48, height: 48, borderRadius: 14, backgroundColor: '#EAF4F1', overflow: 'hidden', alignItems: 'center', justifyContent: 'center' },
