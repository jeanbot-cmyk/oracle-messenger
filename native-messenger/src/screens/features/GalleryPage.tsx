...
const styles = StyleSheet.create({
  ...
  galleryPreviewImage: { width: '100%', aspectRatio: 1, borderRadius: 8, backgroundColor: '#050505' },
  galleryPreviewVideo: { width: '100%', aspectRatio: 1, borderRadius: 8, overflow: 'hidden', backgroundColor: '#050505' },
  galleryVideoPlayer: { width: '100%', height: '100%', backgroundColor: '#050505' },
